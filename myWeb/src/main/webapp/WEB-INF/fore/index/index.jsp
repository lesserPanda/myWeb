...
<link href="/fore/css/styles.css" rel="stylesheet">
<link href="/fore/css/animation.css" rel="stylesheet">
<!-- 返回顶部调用 begin -->
...
<!-- 返回顶部调用 end-->
<!--[if lt IE 9]>
<script src="/fore/js/modernizr.js"></script>
<![endif]-->
</head>
<body>
<header>
...
<div id="mainbody">
  <div class="info">
    <figure> <img src="/fore/images/art.jpg"  alt="Panama Hat">
  ...
  <div class="blogs">
    <ul class="bloglist">
      ...
      <li>
        <div class="arrow_box">
          ...
          <ul class="textinfo">
            <a href="/"><img src="/fore/images/s2.jpg"></a>
      ...
      <li>
        <div class="arrow_box">
          ...
          <ul class="textinfo">
            <a href="/"><img src="/fore/images/s3.jpg"></a>
      ...
      <li>
        <div class="arrow_box">
          ...
          <h2 class="title"><a href="/" target="_blank">谁更心软，谁就先长大</a></h2>
          <ul class="textinfo">
            <a href="/"><img src="/fore/images/s4.jpg"></a>
            <p> 男人都是孩子，需要用一生时间来长大。女人都想当孩子，却最擅长的角色是妈妈。恋爱一开始，是两个孩子之间的游戏，到后来，成了大人和孩子之间的游戏。恋爱这回事，总要有一个人先长大，对另一半多些包容和宠溺。而通常来看：谁更心软，谁就先长大...</p>
          </ul>
          <ul class="details">
            <li class="likes"><a href="#">102</a></li>
      ...
      <li>
        <div class="arrow_box">
          ...
          <ul class="textinfo">
            <a href="/"><img src="/fore/images/s5.jpg"></a>
    ...
    <aside>
      ...
      <div class="viny">
        <dl>
          <dt class="art"><img src="/fore/images/artwork.png" alt="专辑"></dt>
          ...
          <dd class="music">
            <audio src="/fore/images/nf.mp3" controls></audio>
          </dd>
